...
//
// The body lives in `AccessPanel` so it can render both as a standalone page
// (/org, server-prefetched) and inside the settings modal (client-fetched).
export function AccessPanel({ initial }: { initial: MyAccess | null }) {
...
/** Full-page wrapper for /org — kept for direct links and bookmarks. The
 * in-app entry point is 設定 → アクセスできる資料. */
